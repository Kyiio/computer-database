...
/**
 * 
 * Interface that provides methods to check if the data in a company are
 * consistent.
 * 
 * @author B. Herbaut
 *
...
public class CompanyValidator {
	...
	/**
	 * Method that check if the company's id isn't negative or 0.
	 * 
	 * If it is it throws a ValidtionException
	 * 
	 * @param id
	...
	/**
	 * Method that check if the given String isn't null or empty and contains
	 * only a positive int.
	 * 
	 * If not it throws a ValidationException.
	 * 
	 * @param idString
	 *            The String that contains the company id and that will be
	 *            checked.
	 */
	...
	/**
	 * Method that check if the company name isn't empty or null.
	 * 
