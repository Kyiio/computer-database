 ...
 * before calling to the DAO service.
 * 
 * @author B. Herbaut
 */
public interface ComputerDTOService {
	...
	/**
	 * Method that check the information in the computerDTO and then call the
	 * updateComputer method from ComputerService.
	 * 
	 * @param computer
	 ...
	 * the insertComputer method from the ComputerService.
	 * 
	 * @param company
	 * @param introduced
	 * @param discontinued
	 ...
	 * @return The list of computers DTO that matches the given name (or an
	 *         empty list).
	 * @see ComputerDTO, ComputerService
	 */
