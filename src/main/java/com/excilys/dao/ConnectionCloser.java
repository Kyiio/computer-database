...
/**
 * Class that offers different methods to close properly a ResultSet, a
...
public class ConnectionCloser {
	 ...
	 * 
	 * @param resultSet
	 *            The result set that we want to close.
	 */
	 ...
	 * 
	 * @param statement
	 *            The statement that we want to close.
	 */
	 ...
	 * 
	 * @param connection
	 *            The connection that we want to close.
	 */
	 ...
	 * 
	 * @param resultSet
	 *            The resultSet that we want to close.
	 * @param statement
	 *            The statement that we want to close.
	 * @param connection
	 *            The connection that we want to close.
