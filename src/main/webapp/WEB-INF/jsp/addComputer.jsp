...
<body>
                ...
                <div class="col-xs-8 col-xs-offset-2 box">
                    ...
                    <form action="./addComputer" method="POST" id="addComputerForm">
                        <fieldset>
                            ...
                            <div class="form-group">
                                <label for="introduced">Introduced date (Format YYYY-MM-DD)</label>
                                <input type="date" class="form-control" id="introduced" name="introduced" placeholder="Introduced date">
                                <div id="introducedErr"></div>
                            </div>
                            <div class="form-group">
                                <label for="discontinued">Discontinued date (Format YYYY-MM-DD)</label>
    ...
    <script src="js/addComputerCheckForm.js"></script>
</body>
</html>